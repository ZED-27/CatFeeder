...
namespace kormushka
{
    public partial class PetMenu : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command_i = new MySqlCommand("SELECT * FROM feeder WHERE name = @uLi", db.getConnection());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("UPDATE `feeder` SET `condition`= @condition WHERE `name`=@name", db.getConnection());

            command.Parameters.Add("@condition", MySqlDbType.VarChar).Value = res_cond;
            command.Parameters.Add("@name", MySqlDbType.VarChar).Value = labelP.Text;
