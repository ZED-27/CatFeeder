...
namespace kormushka
{
    public partial class Registration : Form
    {
        ...
        private void buttonLogAdm_Click(object sender, EventArgs e)
        {
            ...
            DB db = new DB();
            MySqlCommand command = new MySqlCommand("INSERT INTO `trueusers` ( `login`, `password`, `Name`, `Surname`) VALUES (@login, @password, @name, @surname)", db.getConnection());
        ...
        public bool isUserExist()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM `trueusers` WHERE `login`=@UsL", db.getConnection());
